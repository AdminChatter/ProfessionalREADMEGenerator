...
function renderLicenseSection(license) {
  if (license) {
    return `This project is licensed under the **${license}** license. Click the badge below to learn more about this license. <br>
...
1. GitHub: [${data.username}](https://github.com/${data.username}) <br>
